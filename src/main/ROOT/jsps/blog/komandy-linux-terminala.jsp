...
<pre class="vimcode">
________________________________имя пользователя
|    ___________________________имя компьютера
|    |           _______________текущая директория
|    |           |   ___________приглашение системы к введению команды
|    |           |   | _________имя команды
|    |           |   | |   _____ключи команды
|    |           |   | |   |   _содержательный папаметр
|    |           |   | |   |   |
