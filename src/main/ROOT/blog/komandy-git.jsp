...
<meta name="description" content="Полный список команд git довольно обширен, поэтому здесь приведены только основные - те, которые использую чаще всего.">
</head>
...
<body>
  ...
  <section>
    ...
    <p>Полный список команд <b>git</b> довольно обширен, поэтому здесь приведены только основные - те, которые использую чаще всего.</p>
  </section>
  ...
  <section>
    ...
    <p>Установить email и имя пользователя:</p>
...
git config --global user.name
  ...
  <section>
    ...
    <p>
		...
		<p>Создать пустой файл <b>.gitignore</b> в корне проекта:</p>

		<div class="vimcode">
			vim .gitignore
		</div>

		<p>Исключить от отслеживания все файлы с расширением <b>.class</b>, добавив в файл запись:</p>
  ...
  <section>
    ...
    <p>Удалить все изменения и "откатиться" на один коммит назад:</p>
    ...
    <p>"Откатить" изменения на один коммит, сохранив изменения в файлах (они останутся в staged-состоянии, как после <b>git add</b>):</p>

		<div class="vimcode">
			git reset --soft HEAD~1
		</div>

    <p>"Откатить" изменения, сохранив изменения в файлах, но не добавляя их в staged-состояние:</p>
  ...
  <section>
    ...
    <p>Слить изменений из указанной ветки (feature_1) в текущую:</p>
  ...
  <section>
    ...
    <p>Вывести список удаленных репозиториев (remotes):</p>
    ...
    <p>Где origin - это стандартное имя для удаленных репозиториев.</p>

    <p>Отправить изменения в  удаленный репозиторий <b>origin</b> ветки <b>master</b>:</p>
    ...
    <p>После выполнения команды необходимо ввести логин и пароль (например, при <b>git push</b>).
