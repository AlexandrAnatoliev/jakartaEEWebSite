...
<meta name="description"
  content="Проект Эйлера 4 задача (наибольшее произведение-палиндром) позволила: отработать конструкции языка java, 
...
<body>
  ...
  <section>
    <article class="calculator">
      ...
      <p>Самый большой палиндром, образованный произведением двух n-значных чисел и меньший <b><%= max %></b> это <b><%= answer %> = <%= maxFact1 %> * <%= maxFact2 %></b></p>
  ...
  <section>
    ...
    <p>Также при разложении числа на простые множители не нужно
