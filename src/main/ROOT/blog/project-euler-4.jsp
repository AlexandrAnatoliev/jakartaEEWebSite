...
public class Solution {
  public static void main(String[] args) {
    ...
    <p>Поскольку перебор множителей идет от большего к меньшему, то первый же найденный при переборе <b>fact2</b> палиндром является максимальным и перебор <b>fact2</b> прерывается 
