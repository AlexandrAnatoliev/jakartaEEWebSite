...
<body>
  ...
  <section>
    <aside class="article-preview">
      ...
      <p>Задача "Наибольшее произведение-палиндром" позволила не только познакомиться и отработать новые конструкции языка <b>java</b>,
	...
	<a href="/blog/project-euler-4.jsp"><b>читать</b></a>
     ...
     <aside class="article-preview">
      ...
      создание новой ветки, внесение изменений в код, создание <b>pull request</b> на <b>GitHub</b> и слияние (<b>merge</b>) изменений с основной веткой <b>master</b>...
        <a href="/blog/primer-git.jsp"><b>читать</b></a>
      </p>
    </aside>
