	...
	<head>
  	...
  	<body>
    	...
    	<section>
    		...
    		Он помогает мне уложить знания в голове, служит своеобразной тетрадкой, в которую я могу подсматривать иногда, 
    		а также возможно будет полезен другим.</p>
		</section>	
		...
		<aside>
	  		...
	  		<section class="article-preview">
      			...
      			<p>В данной задаче продолжаю знакомиться с языком <b>java</b>, для чего реализовал 
      			пользовательский ввод, а также установил и запустил программу на удаленном сервере. Как всегда, 
	  		...
	  		<section class="article-preview">
      			...
      			<p>Решая эту задачу, решил не только отработать конструкции языка <b>java</b>, но и разобраться с компиляцией программы без использования <b>ide</b>. 
