...
public class Solution {
  public static void main(String[] args) {
    ...
    System.out.println("Answer is " + answ);
		...
		<p>Число <b>600851475143</b> принимается методом <b>main()</b> в виде элемента массива <b>args[0]</b> содержащего строку <b>"600851475143"</b>.<br>
		Далее, чтобы преобразовать строку в число, применил предопределенный класс <b>Long</b> и его статический метод <b>parseLong()</b>.</p>
