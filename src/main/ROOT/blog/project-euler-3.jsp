...
<html>
  	...
  	<body>
    	...
    	конструкций языка <b>java</b>, реализуем в ней пользовательский ввод через параметры командной строки, все файлы скомпилируем в один <b>jar</b>
    	 архив,	передадим его через <b>ssh</b> и запустим на удаленном сервере.<br>
    	<b>Онлайн-калькулятор</b> для проверки вычислений и <b>правильный ответ</b> 
...
public class Solution {
  public static void main(String[] args) {
    ...
    System.out.println("Answer is " + answ);
		...
		<p>Число,  передачу пользователем проверяемого числа через параметры командной строки java Solution 600851475143</p>
				<li><b>Calculator</b> - содержит методы, необходимые для вычислений.</li>
    <div class="vimcode">
      if (secondFib % 2 == 0)
    </div>
