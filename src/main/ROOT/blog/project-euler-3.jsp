...
<html>
  	...
  	<body>
		...
		<p>При целочисленном делении числа, получается сразу два делителя: максимальный и минимальный. <br/>
		...
		<p>При этом, если перебирать делители от меньшего к большему, то первый найденный делитель будет априори минимальным и простым.</p> 

		<p>Также нет необходимости проверять все делители от <b>2</b> до самого раскладываемого числа. Достаточно проверить делители только до 
...
//Calculator.java - продолжение
  long getMaxPrimeDiv(long num) {
    ...
    return num;
		...
		Последний полученный множитель и будет искомым <b>максимальным простым делителем</b>.</p>
...
Answer is 6857
    	...
    	<p>В данной программе применил несколько новых конструкций языка <b>java</b>:
      		<ul>
