...
7 - содержательный параметр (показать содержимое src)
    ...
    <p>Удалить <b>file</b>.</p>
	  ...
	  <p>Удалить директорию и все ее содержимое. Проходит по директории рекурсивно и удалаяет все файлы (в linux директории тоже являются файлами).</p>
...
# cd ./bin  относительный
    ...
    <h3>Просмотр файлов</h3>
	  ...
	  <div class="vimcode">
		...
		<p>Вывести последние 10 строк файла.</b>.
...
# tail -f /var/log/auth.log
    ...
    <p>Команда для поиска файдов в linux. Имеет много параметров и столько же возможностей.</p>
...
<p>Наиболее популярные права доступа:
  <ul>
    <li><b>644</b> - владельцу можно читать и изменять файл, остальным пользователям - полько читать</li>
