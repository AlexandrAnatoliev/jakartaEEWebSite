...
<html>
  ...
  <body>
    ...
    <p>Решая <b>1 задачу проекта Эйлера</b>, можно не только отработать конструкции языка <b>java</b>, но и разобраться с компиляцией программы без использования <b>ide</b>. 
    Как бонус, сделан небольшой <b>онлайн-калькулятор</b>, позволяющий проверить Ваши вычисления и приведен <b>ответ</b> на задачу.</p>

    <div id="top">
      <h3>Числа, кратные 5 или 5</h3>
    </div>

    <p>Если выписать все натуральные числа меньше <b>10</b>, кратные <b>3</b> или <b>5</b>, то получим <b>3, 5, 6</b> и <b>9</b>. Сумма этих чисел равна <b>23</b>.</p>

    <p>Найдите сумму всех чисел меньше <b>1000</b>, кратных <b>3</b> или <b>5</b>.</p>
...
public class Problem1 {
  ...
  public static void main(String[] args) {
    ...
    <p>В цикле <b>for</b> перебираем натуральные числа <b>num</b> от одного до тысячи. Каждое из них проверяем на соответствие условиям задачи.
    Числа, удовлетворяющие условиям задачи, суммируем в переменную <b>answer</b>.</p>
...
Answer = 233168
    ...
    <p>Даже при том, что сложность этой программы уровня <b>Hello world</b>, в ней применен ряд конструкций языка <b>java</b>:
      <ul>
