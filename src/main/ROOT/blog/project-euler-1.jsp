...
<html>
  ...
  <body>
    ...
    <p>Решая эту задачу, постарался не только отработать конструкции языка <b>java</b>, но и разобраться с компиляцией программы без использования <b>ide</b>. 
    ...
    <p><i>Если выписать все натуральные числа меньше <b>10</b>, кратные <b>3</b> или <b>5</b>, то получим <b>3, 5, 6</b> и <b>9</b>. Сумма этих чисел равна <b>23</b>.<br/>

    Найдите сумму всех чисел меньше <b>1000</b>, кратных <b>3</b> или <b>5</b>.</i></p>
...
public class Solution {
  public static void main(String[] args) {
    ...
    <div id="top">
	  ...
	  <p>Поскольку программирование это не только код, но и такие вопросы как настройка, отладка и т.п., скомпилирую файл в прямо консоли:</p>
...
Answer = 233168
    ...
    <p>Вопросы компиляции <b>java</b> были подробно описаны ранее, не буду повторяться:</p>
